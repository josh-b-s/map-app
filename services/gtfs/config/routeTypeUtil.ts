...
export function classifyRouteType(routeType: number): RouteTypeInfo {
    ...
    switch (routeType) {
        case 0:
            return {category: 'tram', label: 'Tram'};
        case 1:
            return {category: 'metro', label: 'Metro'};
        case 2:
            return {category: 'rail', label: 'Train'};
        case 3:
            return {category: 'bus', label: 'Bus'};
        case 4:
            return {category: 'ferry', label: 'Ferry'};
        case 5:
            return {category: 'cable', label: 'Cable Car'};
        case 6:
            return {category: 'aerial', label: 'Aerial Lift'};
        case 7:
            return {category: 'funicular', label: 'Funicular'};
        case 11:
            return {category: 'bus', label: 'Trolleybus'};
        case 12:
            return {category: 'rail', label: 'Monorail'};
    }

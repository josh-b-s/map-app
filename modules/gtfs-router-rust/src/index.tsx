...
import installer from './NativeGtfsRouterRust';
...
export * from './generated/gtfs_router';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as gtfs_router from './generated/gtfs_router';
...
if (!initialized) {
  gtfs_router.default.initialize();
  initialized = true;
}

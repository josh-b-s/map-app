...
@ReactModule(name = GtfsImporterModule.NAME)
class GtfsImporterModule(reactContext: ReactApplicationContext) :
  NativeGtfsImporterSpec(reactContext) {
  ...
  companion object {
    const val NAME = "GtfsImporter"

    init {
      System.loadLibrary("gtfs-importer")
    }
  }
}
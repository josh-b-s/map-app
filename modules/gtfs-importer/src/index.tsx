...
import installer from './NativeGtfsImporter';
...
export * from './generated/gtfs_importer';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as gtfs_importer from './generated/gtfs_importer';
...
if (!initialized) {
  gtfs_importer.default.initialize();
  initialized = true;
}
